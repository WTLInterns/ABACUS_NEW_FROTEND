...
export default function AdminOverviewPage(): React.JSX.Element {
  return (
    <Grid container spacing={3}>
      ...
      >
        <Traffic chartSeries={[63, 15, 22]} labels={['Elementary', 'Middle', 'High']} sx={{ height: '100%' }} />
      </Grid>
      <Grid
        size={{
          lg: 4,
      ...
      >
        <LatestOrders
          orders={[
            {
              id: 'ORD-007',
              customer: { name: 'Teacher Recruitment' },
              amount: 30.5,
              status: 'pending',
            ...
            {
              id: 'ORD-006',
              customer: { name: 'Infrastructure Upgrade' },
              amount: 25.1,
              status: 'delivered',
              createdAt: dayjs().subtract(10, 'minutes').toDate(),
            },
            {
              id: 'ORD-004',
              customer: { name: 'Curriculum Development' },
              amount: 10.99,
              status: 'refunded',
              createdAt: dayjs().subtract(10, 'minutes').toDate(),
            },
            {
              id: 'ORD-003',
              customer: { name: 'Technology Integration' },
              amount: 96.43,
              status: 'pending',
              createdAt: dayjs().subtract(10, 'minutes').toDate(),
            },
            {
              id: 'ORD-002',
              customer: { name: 'Professional Development' },
              amount: 32.54,
              status: 'delivered',
              createdAt: dayjs().subtract(10, 'minutes').toDate(),
            },
            {
              id: 'ORD-001',
              customer: { name: 'Student Support Programs' },
              amount: 16.76,
              status: 'delivered',
              createdAt: dayjs().subtract(10, 'minutes').toDate(),
            },
